    ...
    const featuredWebinars = [
        {
            ...
            description: 'Dive deep into the fundamentals of music theory and enhane your musical skills.',
        ...
        <div className="p-12 bg-gray-900 ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="text-center">
                    ...
                    <p className=" mt-2 text-3xl leading-8 text-white sm:text-4xl " >Enhance your musical journey</p>
                </div>
                <div className="mt-10">
                    <HoverEffect 
